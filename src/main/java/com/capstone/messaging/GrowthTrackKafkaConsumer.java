...
public class GrowthTrackKafkaConsumer {
    ...
    @Value("${KAFKA_GROWTH_TRACK_DLT_TOPIC:growthTrack.create.dlt}")
    ...
    @Retryable(
            retryFor = {GrowthTrackProcessingException.class, TrackCapsuleMappingException.class, CapsuleNotFoundException.class,
                    Exception.class},
            backoff = @Backoff(delay = 1000, multiplier = 2)
    )
